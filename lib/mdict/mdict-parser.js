 ...
 */
      ...
      // var mdds = Array.prototype.filter.call(files,function(f){
      //   var ext =  common.getExtension(f.name, 'mdx');
      //   return ext === 'mdd'
      // })

      // var mdx = Array.prototype.find.call(files,function(f){
      //   var ext =  common.getExtension(f.name, 'mdx');
      //   return ext === 'mdx'
      // })
      ...
      //  Array.prototype.forEach.call(mdds,f=>{
      //   list.push(f)
      // })

      // console.log(list)
      
      // var merged = new File(list,'final.mdd')
